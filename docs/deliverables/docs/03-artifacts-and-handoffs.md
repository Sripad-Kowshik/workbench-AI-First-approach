...
2. CHF-execute creates the hotfix branch and cherry-picks commits.
3. CHF-execute emits a diff request and ends.
4. Diff agent emits a diff manifest.
5. Pack agent consumes the manifest and emits packaging artifacts.
6. CHF-finalize performs review and tagging steps.
